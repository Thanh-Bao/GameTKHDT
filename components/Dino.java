...
public class Dino {
	private static int dinoTopY, dinoStartX, dinoEndX;
	...
	public Dino() {
		image = new Resource().getResourceImage("../images/stand.png");
		leftFootDino = new Resource().getResourceImage("../images/left.png");
		rightFootDino = new Resource().getResourceImage("../images/right.png");
		deadDino = new Resource().getResourceImage("../images/die.png");
  
		dinoTopY = 465 - image.getHeight();
		dinoStartX = 100;
		dinoEndX = dinoStartX + image.getWidth();
		topPoint = dinoTopY - 200;
